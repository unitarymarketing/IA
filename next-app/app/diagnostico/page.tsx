  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white selection:bg-indigo-500/30">
      <div className="max-w-5xl mx-auto px-6 py-16 md:py-24">
        ...
        {/* Pill-Grid */}
        <div className="flex overflow-x-auto md:flex-wrap gap-2.5 pb-4 md:pb-0 mb-12 no-scrollbar md:justify-center">
          {filteredRubros.map((rubro) => {
            ...
            return (
              <button
                ...
                className={`flex-shrink-0 px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 backdrop-blur ${
                  isActive
              ...
              <div className="flex-1 bg-black/40 border border-white/5 rounded-2xl p-6 md:p-8 flex flex-col justify-between">
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-8 pt-6 border-t border-white/10">
                    <div>
                      <p className="text-neutral-500 text-xs font-medium uppercase tracking-wider mb-1">Inversión Estimada</p>
                      <p className="text-white font-semibold text-lg">
                        US${selectedRubro.priceRangeUSD.min.toLocaleString()} - US${selectedRubro.priceRangeUSD.max.toLocaleString()}
                      </p>
                    </div>
                    <div>
                      <p className="text-neutral-500 text-xs font-medium uppercase tracking-wider mb-1">Tiempo de Entrega</p>
                      <p className="text-white font-semibold text-lg">
                        {selectedRubro.estimatedTimeWeeks} semanas
                      </p>
                    </div>
                  </div>
                </div>
